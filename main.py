...
parser.add_argument('--algorithms'
                    , type=str, default='TD3', help='algorithm')
...
with torch.no_grad():device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
...
elif args.algorithms == 'TD3':
    from algorithms import TD3
    agent = TD3.Agent(args.isEval, args.simulator, args.hidden_size, args.gamma, args.behavior_update, args.replay_buffer_size, args.batch_size).to(device)
